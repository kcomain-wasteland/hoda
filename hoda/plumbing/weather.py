...
class Weather:
    ...
    def __init__(self, session=None, *, language: constants.LANGUAGE = 'en'):
        """Initialize the class
        
        :param session: aiohttp session, leave blank to let the library create one for you.
        :kwarg language: Language to use
        """
        if not session:
            self.session = ...
